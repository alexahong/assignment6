...
* @brief runs functions to play othello and determine whether its your move or the computer. 
* Displays messages to the user and evlauates the AI potenial next move.
...
* @param message - the message that will be displayed to user
* @return void
*/
